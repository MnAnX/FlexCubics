...
<module external.linked.project.id=":react-native-youtube" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:/Users/nanxiao/dev/advice-coach/mobile/advicecoach/node_modules/react-native-youtube/android/libs/YouTubeAndroidPlayerApi.jar:unspecified@jar" level="project" />
